            ...
            <div class="mb-4 col-lg-8 mb-lg-0">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th class="pl-0 border-0" scope="row">
                                    <div class="media align-items-center"><a class="reset-anchor d-block animsition-link"
                                            href="{{ route('frontend.detail') }}"><img
                                                src="{{ asset('frontend/img/product-detail-3.jpg') }}" alt="..."
                                                width="70" /></a>
                                        <div class="ml-3 media-body"><strong class="h6"><a
                                                    class="reset-anchor animsition-link"
                                                    href="{{ route('frontend.detail') }}">Red digital
                                ...
                                <td class="align-middle border-0">
                                    <div class="px-3 border d-flex align-items-center justify-content-between"><span
                                        ...
                                        <div class="quantity">
                                            ...
                                            <input class="p-0 border-0 form-control form-control-sm shadow-0" type="text"
                                                value="1" />
                            ...
                            <tr>
                                <th class="pl-0 border-light" scope="row">
                                    <div class="media align-items-center"><a class="reset-anchor d-block animsition-link"
                                            href="{{ route('frontend.detail') }}"><img
                                                src="{{ asset('frontend/img/product-detail-2.jpg') }}" alt="..."
                                                width="70" /></a>
                                        <div class="ml-3 media-body"><strong class="h6"><a
                                                    class="reset-anchor animsition-link"
                                                    href="{{ route('frontend.detail') }}">Apple watch</a></strong></div>
                                    </div>
                                </th>
                ...
                <div class="px-4 py-3 bg-light">
                    <div class="text-center row align-items-center">
                        <div class="mb-3 col-md-6 mb-md-0 text-md-left"><a class="p-0 btn btn-link text-dark btn-sm"
                                href="{{ route('frontend.shop') }}"><i class="mr-2 fas fa-long-arrow-alt-left">
                        ...
                        <div class="col-md-6 text-md-right"><a class="btn btn-outline-dark btn-sm"
                                href="{{ route('frontend.checkout') }}">Procceed to checkout<i
                                    class="ml-2 fas fa-long-arrow-alt-right"></i></a></div>
                    </div>
                </div>
            </div>
            <!-- ORDER TOTAL-->
                ...
                <div class="border-0 card rounded-0 p-lg-4 bg-light">
                    <div class="card-body">
                        ...
                        <ul class="mb-0 list-unstyled">
                            ...
                            <li class="mb-4 d-flex align-items-center justify-content-between"><strong
                                ...
                                <form action="#">
                                    <div class="mb-0 form-group">
                                        ...
                                        <button class="btn btn-dark btn-sm btn-block" type="submit"> <i
                                                class="mr-2 fas fa-gift"></i>Apply coupon</button>
                                    </div>
                                </form>
                            </li>
                        </ul>
