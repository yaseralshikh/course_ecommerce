        ...
        <div class="container p-0">
            <div class="row">
                ...
                <div class="order-2 col-lg-3 order-lg-1">
                    ...
                    <div class="px-4 py-2 mb-3 text-white bg-dark"><strong
                    ...
                    <div class="px-4 py-2 mb-3 bg-light"><strong
                    ...
                    <div class="pt-4 mb-5 price-range">
                        ...
                        <div class="pt-2 row">
                            ...
                            <div class="text-right col-6"><strong class="small font-weight-bold text-uppercase">To</strong>
                            </div>
                        </div>
                    </div>
                ...
                <div class="order-1 mb-5 col-lg-9 order-lg-2 mb-lg-0">
                    <div class="mb-3 row align-items-center">
                        <div class="mb-2 col-lg-6 mb-lg-0">
                            <p class="mb-0 text-small text-muted">Showing 1–12 of 53 results</p>
                        </div>
                        <div class="col-lg-6">
                            <ul class="mb-0 list-inline d-flex align-items-center justify-content-lg-end">
                                <li class="mr-3 list-inline-item text-muted"><a class="p-0 reset-anchor" href="#"><i
                                            class="fas fa-th-large"></i></a></li>
                                <li class="mr-3 list-inline-item text-muted"><a class="p-0 reset-anchor" href="#"><i
                                            class="fas fa-th"></i></a></li>
                                <li class="list-inline-item">
                                    <select class="ml-auto selectpicker" name="sorting" data-width="200"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                <div class="mb-3 position-relative">
                                    <div class="text-white badge badge-"></div><a class="d-block" href="{{ route('frontend.detail') }}"><img
                                            class="img-fluid w-100" src="{{ asset('frontend/img/product-1.jpg') }}" alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-outline-dark"
                                                    href="#"><i class="far fa-heart"></i></a></li>
                                            <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-dark"
                                                    href="{{ route('frontend.cart') }}">Add to cart</a></li>
                                            <li class="mr-0 list-inline-item"><a class="btn btn-sm btn-outline-dark"
                                                    href="#productView" data-toggle="modal"><i
                                                        class="fas fa-expand"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Kui Ye Chen’s AirPods</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Air Jordan 12 gym red</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                <div class="mb-3 position-relative">
                                    <div class="text-white badge badge-primary">New</div><a class="d-block"
                                        href="{{ route('frontend.detail') }}"><img class="img-fluid w-100" src="{{ asset('frontend/img/product-3.jpg') }}"
                                            alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-outline-dark"
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Cyan cotton t-shirt</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Timex Unisex Originals</a></h6>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                <div class="mb-3 position-relative">
                                    <div class="text-white badge badge-info">Sale</div><a class="d-block"
                                        href="{{ route('frontend.detail') }}"><img class="img-fluid w-100" src="{{ asset('frontend/img/product-5.jpg') }}"
                                            alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-outline-dark"
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Red digital smartwatch</a></h6>
                                <p class="small text-muted">$250</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Nike air max 95</a></h6>
                                <p class="small text-muted">$300</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Joemalone Women prefume</a></h6>
                                <p class="small text-muted">$25</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Apple Watch</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                <div class="mb-3 position-relative">
                                    <div class="text-white badge badge-danger">Sold</div><a class="d-block"
                                        href="{{ route('frontend.detail') }}"><img class="img-fluid w-100" src="{{ asset('frontend/img/product-9.jpg') }}"
                                            alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-outline-dark"
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Men silver Byron Watch</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                <div class="mb-3 position-relative">
                                    <div class="text-white badge badge-primary">New</div><a class="d-block"
                                        href="{{ route('frontend.detail') }}"><img class="img-fluid w-100" src="{{ asset('frontend/img/product-10.jpg') }}"
                                            alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-outline-dark"
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Ploaroid one step camera</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                <div class="mb-3 position-relative">
                                    <div class="text-white badge badge-"></div><a class="d-block" href="{{ route('frontend.detail') }}"><img
                                            class="img-fluid w-100" src="{{ asset('frontend/img/product-11.jpg') }}" alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-outline-dark"
                                                    href="#"><i class="far fa-heart"></i></a></li>
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Gray Nike running shoes</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                        <!-- PRODUCT-->
                        <div class="col-lg-4 col-sm-6">
                            <div class="text-center product">
                                <div class="mb-3 position-relative">
                                    <div class="text-white badge badge-"></div><a class="d-block" href="{{ route('frontend.detail') }}"><img
                                            class="img-fluid w-100" src="{{ asset('frontend/img/product-12.jpg') }}" alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-outline-dark"
                                                    href="#"><i class="far fa-heart"></i></a></li>
                                ...
                                <h6> <a class="reset-anchor" href="{{ route('frontend.detail') }}">Black DSLR lense</a></h6>
                                <p class="small text-muted">$351</p>
                            </div>
                        </div>
                    </div>
