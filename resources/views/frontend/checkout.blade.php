...
@section('content')
    ...
    <section class="py-5 bg-light">
        <div class="container">
            <div class="px-4 row px-lg-5 py-lg-4 align-items-center">
                <div class="col-lg-6">
                    <h1 class="mb-0 h2 text-uppercase">Checkout</h1>
                </div>
    ...
    <section class="py-5">
        <!-- BILLING ADDRESS-->
        <h2 class="mb-4 h5 text-uppercase">Billing details</h2>
        <div class="row">
            <div class="col-lg-8">
                <form action="#">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="row d-none" id="alternateAddress">
                                <div class="mt-4 col-12">
                                    <h2 class="mb-4 h4 text-uppercase">Alternative billing details</h2>
                                </div>
                                <div class="col-lg-6 form-group">
            ...
            <div class="col-lg-4">
                <div class="border-0 card rounded-0 p-lg-4 bg-light">
                    <div class="card-body">
                        <h5 class="mb-4 text-uppercase">Your order</h5>
