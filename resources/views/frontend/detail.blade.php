                    ...
                    <div class="row m-sm-0">
                        <div class="order-2 mt-2 col-sm-2 p-sm-0 order-sm-1 mt-sm-0">
                            <div class="flex-row owl-thumbs d-flex flex-sm-column" data-slider-id="1">
                                <div class="mb-2 mr-2 owl-thumb-item flex-fill mr-sm-0"><img class="w-100"
                                ...
                                <div class="mb-2 owl-thumb-item flex-fill"><img class="w-100"
                                        src="{{ asset('frontend/img/product-detail-4.jpg') }}" alt="..."></div>
                            </div>
                        </div>
                        <div class="order-1 col-sm-10 order-sm-2">
                            <div class="owl-carousel product-slider" data-slider-id="1">
                                <a class="d-block" href="{{ asset('frontend/img/product-detail-1.jpg') }}"
                                    data-lightbox="product" title="Product item 1">
                                    <img class="img-fluid" src="{{ asset('frontend/img/product-detail-1.jpg') }}"
                                        alt="...">
                                </a>
                                <a class="d-block" href="{{ asset('frontend/img/product-detail-2.jpg') }}"
                                    data-lightbox="product" title="Product item 2">
                                    <img class="img-fluid" src="{{ asset('frontend/img/product-detail-2.jpg') }}"
                                        alt="...">
                                </a>
                                <a class="d-block" href="{{ asset('frontend/img/product-detail-3.jpg') }}"
                                    data-lightbox="product" title="Product item 3">
                                    <img class="img-fluid" src="{{ asset('frontend/img/product-detail-3.jpg') }}"
                                        alt="...">
                                </a>
                                <a class="d-block" href="{{ asset('frontend/img/product-detail-4.jpg') }}"
                                    data-lightbox="product" title="Product item 4">
                                    <img class="img-fluid" src="{{ asset('frontend/img/product-detail-4.jpg') }}"
                                        alt="...">
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-4 row align-items-stretch">
                        <div class="col-sm-5 pr-sm-0">
                            <div
                                class="px-3 py-1 bg-white border border-white d-flex align-items-center justify-content-between">
                    ...
                    </div><a class="p-0 mb-4 btn btn-link text-dark" href="#"><i class="mr-2 far fa-heart"></i>Add to wish
                        list</a><br>
                    <ul class="list-unstyled small d-inline-block">
                        ...
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong
                                class="text-uppercase text-dark">Category:</strong><a class="ml-2 reset-anchor"
                                href="#">Demo Products</a></li>
                        <li class="px-3 py-2 mb-1 bg-white text-muted"><strong
                                class="text-uppercase text-dark">Tags:</strong><a class="ml-2 reset-anchor"
            ...
            <div class="mb-5 tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                    <div class="p-4 bg-white p-lg-5">
                        ...
                        <p class="mb-0 text-muted text-small">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                ...
                <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                    <div class="p-4 bg-white p-lg-5">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="mb-3 media"><img class="rounded-circle"
                                    ...
                                    <div class="ml-3 media-body">
                                        ...
                                        <ul class="mb-1 text-xs list-inline">
                                            ...
                                            <li class="m-0 list-inline-item"><i class="fas fa-star text-warning"></i></li>
                                            <li class="m-0 list-inline-item"><i class="fas fa-star text-warning"></i></li>
                                            <li class="m-0 list-inline-item"><i
                                                    class="fas fa-star-half-alt text-warning"></i></li>
                                        </ul>
                                        <p class="mb-0 text-small text-muted">Lorem ipsum dolor sit amet, consectetur
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="text-center product skel-loader">
                        <div class="mb-3 d-block position-relative"><a class="d-block" href="{{ route('frontend.detail') }}"><img
                            ...
                            <div class="product-overlay">
                                <ul class="mb-0 list-inline">
                                    ...
                                    <li class="p-0 m-0 list-inline-item"><a class="btn btn-sm btn-dark" href="#">Add to
                                            cart</a></li>
