    ...
    <section class="py-5 bg-light">
        <div class="container">
            <div class="px-4 row px-lg-5 py-lg-4 align-items-center">
                <div class="col-lg-6">
                    <h1 class="mb-0 h2 text-uppercase">{{ __('Reset Password') }}</h1>
                </div>
    ...
    <section class="py-5">
        <div class="row">
            <div class="col-6 offset-3">
                <h2 class="mb-4 h5 text-uppercase">{{ __('Reset Password') }}</h2>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <button class="btn btn-dark btn-sm btn-block" type="submit">{{ __('Send Password Reset Link') }}</button>
                        </div>
                    </div>
                </form>
            </div>
